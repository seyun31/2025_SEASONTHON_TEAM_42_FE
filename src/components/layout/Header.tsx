        ...
        <div className="hidden md:flex justify-center items-center w-32 gap-3 relative">
          {isLoggedIn ? (
            <>
              ...
              {/* 로그인 상태 드롭박스 모달 */}
              {isDropdownOpen && (
                <div className="absolute top-full right-0 mt-2 w-[180px] h-[220px] bg-white rounded-[12px] shadow-lg z-50">
                  <div className="p-4 h-full flex flex-col">
                    ...
                    <div className="flex-1 flex flex-col justify-center">
                      <button
                        ...
                        className="w-full text-left px-3 py-2 text-sm font-medium text-black cursor-pointer flex items-center gap-2"
                      >
                        <Image
                      ...
                      <button
                        ...
                        className="w-full text-left px-3 py-2 text-sm font-medium cursor-pointer flex items-center gap-2"
                      >
                        <Image
